...
const Home = ({ addtoCart, userId, isLoggedIn }) => {
  ...
  return (
    <Container sx={{ flexGrow: 1, py: 1, maxWidth: "100%", backgroundColor:"white" }}>
      <Box
        sx={{
          display: "flex",
      ...
      >
        ...
        <Box sx={{ flex: { md: "2 1 40%", xs: "1 1 100%" } }}>
          <Box
            sx={{ display: "flex", alignItems: "center", mb: { xs: 0, md: 2 } }}
          >
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 1, mt: 2 }}>
            <Typography
              variant="h6"
              sx={{ color: "#f28c38", fontFamily: '"Poppins", sans-serif' }}
            >
              $120
            </Typography>
            <Typography
